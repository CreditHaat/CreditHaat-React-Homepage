...
function PersonalLoanProduct() {
  ...
  const faqData = [
    { question: 'What is the qualification criteria for personal loans?',  answer: (
      <>
        <p>
          1. You can check out the lenders where your eligibility is matched from the <a href="#">personal loan eligibility form</a>. 
        ...
        {activeContainer === 'otpVerification' && !otpVerified && (
          <div className="ploanrow">
            ...
            <form onSubmit={handleSubmit}>
                  ...
                  <button type="submit" className="ploan-btn-btn-primary">Request OTP</button>
                </form>
              </div>
            </div>
